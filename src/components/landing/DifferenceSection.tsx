const ROWS = [
  ...
  { label: "Hébergement", cloud: "Serveurs partagés multi-clients", us: "Hardware dédié, mono-cabinet" },
    ...
    <section id="difference" className="py-20 md:py-28 bg-surface border-y border-border">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-10 md:hidden space-y-4">
          {ROWS.map((row) => (
            <div key={row.label} className="rounded-lg border border-border bg-background p-5">
